...
namespace Extern
{
    internal partial class Default : ClusterAlgorithmWrapper
    {
#if ANDROID
        public const string LibraryName0 = "libDefaultAlgorithm.so"; // and so on for other libraries
#elif IOS
        public const string LibraryName0 = "DefaultAlgorithm";
#else
        public const string LibraryName0 = "DefaultAlgorithm.dll";
#endif
