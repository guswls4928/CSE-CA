...
namespace ImgCluster {
    ...
    struct ImageCluster {
        ...
        // Center position(display position) of the cluster
        Point pos;
    ...
    public:
         ...
         */
        virtual Benchmark init(const Images& imageList, unsigned long mapWidth, unsigned long mapHeight, unsigned int screenWidth, unsigned int screenHeight);
        /**
         * @brief
         *
